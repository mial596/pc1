...
export const generateShareableImage = async (images: CatImage[]): Promise<string> => {
    ...
    // --- Title ---
    drawText(ctx, "¡Nuevos Gatos Desbloqueados!", CANVAS_WIDTH / 2, PADDING + 60, "bold 72px 'Nunito', sans-serif", "#3d352e");
