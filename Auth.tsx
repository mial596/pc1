...
const Auth: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-center p-4 bg-wheat">
      <div className="w-full max-w-sm mx-auto bg-seasalt rounded-2xl p-8 border-4 border-liver shadow-[10px_10px_0_#5D4037]">
        <div className="flex flex-col items-center mb-6">
          <img src={LOGO_URL} alt="PictoCat Logo" className="w-24 h-24 mb-4" />
          <h1 className="text-4xl font-black text-liver">PictoCat</h1>
        </div>
