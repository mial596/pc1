    ...
    <div className="featured-item-card relative overflow-hidden p-6 rounded-2xl mb-12 text-center md:text-left shadow-lg" onClick={onOpenShop}>
        <div className="relative z-10 flex flex-col md:flex-row items-center gap-6">
            ...
            <div>
                ...
                <h2 className="text-3xl font-black text-ink drop-shadow-md font-cartoon">{envelope.name}</h2>
        ...
        <div className="max-w-3xl mx-auto">
            {shopData === null ? (
                ...
                <>
                    ...
                    <h1 className="text-3xl sm:text-4xl font-black text-ink mb-4 font-cartoon">¡Bienvenido a la Tienda!</h1>
