...
import { SpinnerIcon, UsersIcon, VerifiedIcon, ArrowLeftIcon, CatSilhouetteIcon, GiftIcon } from '../hooks/Icons';
                            ...
                            <div key={friend.userId} className="card-themed p-3 flex justify-between items-center">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div className="flex items-center gap-2">
                                        <button onClick={() => setSelectedFriendId(friend.userId)} className="font-bold hover:underline flex items-center gap-2">
                                            {friend.username}
                                            {friend.friendship?.activeMission?.isCompleted && (
                                                <span title="¡Misión completada! Haz clic para reclamar.">
                                                    <GiftIcon className="w-6 h-6 text-secondary animate-pulse" />
                                                </span>
                                            )}
                                        </button>
